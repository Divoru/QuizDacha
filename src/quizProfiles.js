...
export function buildLeadModalViewModel(variant = "a") {
  if (variant === "b") {
    return {
      title: "Получите бесплатный отчет по вашей даче",
      description:
      ...
      bullets: [
        "что важно проверить по вашей даче",
        "на что обратить внимание в первую очередь",
        "какие риски и вопросы могут потребовать уточнения",
      ],
      placeholder: "Телефон или почта или мессенджер",
      submitButtonText: "Получить отчет по даче",
      skipButtonText: "Я еще подумаю...",
      emptyErrorText:
        "Пожалуйста, укажите контакт, чтобы мы могли отправить вам отчет по даче",
    };
  }
